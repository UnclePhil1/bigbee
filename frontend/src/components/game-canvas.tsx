...
export function GameCanvas({
  ...
  }, [isGameStarted, setScore, setGameOver, setFinalScore, stageId, onHoneyJarCollected])
  ...
  return (
    <>
      ...
      <div id="controls" className="absolute bottom-5 w-full flex items-end justify-center">
        <div className="grid grid-cols-3 gap-2.5">
          <button
            id="forward"
            onClick={() => handleControlClick("forward")}
            className="col-span-3 w-full h-10 bg-white border border-gray-300 shadow-[3px_5px_0px_0px_rgba(0,0,0,0.75)] cursor-pointer outline-none font-['Press_Start_2P'] text-lg"
          ...
          <button
            ...
            className="w-full h-10 bg-white border border-gray-300 shadow-[3px_5px_0px_0px_rgba(0,0,0,0.75)] cursor-pointer outline-none font-['Press_Start_2P'] text-lg"
            disabled={!isGameStarted || isGameOver}
          >
            ◀
          </button>
